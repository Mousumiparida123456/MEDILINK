          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-2xl sm:text-3xl font-extrabold">MediLinkRx Manager Console</h1>
              ...
              <div className="bg-white p-6 sm:p-8 rounded-3xl shadow-soft border border-slate-100 space-y-6">
                ...
                <div className="space-y-4 max-w-lg">
                  ...
                  <div>
                    ...
                    <input type="email" readOnly value={user?.email || 'manager@medilinkrx.com'} className="w-full bg-slate-50 border border-slate-200 rounded-xl p-3 text-sm font-semibold text-slate-800" />
                  </div>
                  <div>
