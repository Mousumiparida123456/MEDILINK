...
export function Reviews() {
  const reviews = [
    { name: "Sarah Jenkins", role: "Patient", rating: 5, text: "Rx Find saved me so much time. I used to call 5 different pharmacies to find my asthma inhaler, now I just search and reserve it instantly." },
    ...
    { name: "Dr. James Wilson", role: "Physician", rating: 5, text: "I now recommend Rx Find to all my patients so they can easily find where their prescriptions are in stock." },
  ];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="text-center max-w-3xl mx-auto mb-16">
        ...
        <p className="text-lg text-slate-600">See what our community has to say about their experience with Rx Find.</p>
      </div>
