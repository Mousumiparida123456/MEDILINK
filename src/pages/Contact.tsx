  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="text-center max-w-3xl mx-auto mb-16">
        ...
        <p className="text-lg text-slate-600">Have questions about MediLinkRx? We're here to help patients, pharmacies, and developers.</p>
      </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600">support@medilinkrx.com</p>
                  <p className="text-slate-600">partners@medilinkrx.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600">1-800-MEDILINKRX</p>
